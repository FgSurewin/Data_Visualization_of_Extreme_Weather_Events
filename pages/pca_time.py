...
layout = html.Div([
    html.H1('Time Series Plot', style={"textAlign": "center", "marginBottom": "50px", "marginTop": "50px"}),
    dbc.Row([
            dbc.Col(
                [
                    html.H2("Findings:"),
                    ...
                    html.P("The next visualization is the time series plot of the second principal component. The plot shows a peak value in principal component scores in 2008, which contributes to the hurricane Ika, one of the most destructive landfalling storms in the US with $29.5 billion loss. Here also we used color encoding to differentiate between different types of extreme weather events."),
                ],
                width=12,
                lg=4,
